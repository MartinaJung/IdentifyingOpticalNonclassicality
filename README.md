...
Let's assume, you have $3$ modes and $1000$ samples per state and saved the dataset with the name "ds1_test" in your *datasets* subfolder. First, edit the respective hyperparameters in the file *hyperparams.py*.
