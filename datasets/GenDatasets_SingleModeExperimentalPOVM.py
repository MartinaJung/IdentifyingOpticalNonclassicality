...
def ProbDistr1Mode(detector_type, species, ampl):
...
def ClickDistr(detector_type, species, ampl, num_samples, abs_path):
...
def load_exp_CoherentStates(detector_type, shots_per_state, abs_path):
...
def SampleClassicalStates(detector_type, shots_per_state, abs_path):
...
def SampleNonClassicalStates(detector_type, shots_per_state, abs_path):
